package by.it.group451002.baguzov.lesson14;
...
public class StatesHanoiTowerC {
    ...
    public static void main(String[] args) {
        ...
        int maxSize = (1 << N) - 1;
        int[] stepsHeights = new int[N];
        Arrays.fill(stepsHeights, -1);
        DSU dsu = new DSU(maxSize);
        ...
        for (int i = 0; i < maxSize; i++) {
            ...
            if (stepsHeights[maxHeightIndex] == -1)
                stepsHeights[maxHeightIndex] = i;
            else
                dsu.unionSets(stepsHeights[maxHeightIndex], i);
        }
